package org.cclgdx.utils.collections;

import java.util.ArrayList;
import java.util.HashMap;

import org.cclgdx.utils.pool.OneClassPool;

/**
 * This class is temporary replacement of ConcurrentHashMap<K,V> for frequently
 * iterating through values. See firstValue, nextValue methods. Do not use this
 * outside, this is not optimized. Put into HashMap still causes new Entry, but
 * iteration is done without call to values().
 * 
...
public class ConcurrentArrayHashMap<K, V> {
	 ...
	 * 
	 * Iteration is organized in this manner: Iteration is organized in this
	 * manner: for(ConcurrentArrayHashMap<K, V>.Entry e = targets.firstValue();
	 ...
	 * 
	 * Iteration is organized in this manner: for(ConcurrentArrayHashMap<K,
	 * V>.Entry e = targets.firstValue(); e != null; e = targets.nextValue(e)) {

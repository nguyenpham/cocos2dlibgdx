...
public class CCAnimate extends CCIntervalAction {
	...
	private final boolean restoreOriginalFrame;
	...
	/**
	 * creates an action with a duration, animation and depending of the
	 * restoreOriginalFrame, it will restore the original frame or not. The
	 * 'delay' parameter of the animation will be overrided by the duration
	 * parameter.
	 */
	...
	/**
	 * creates the action with an Animation and will restore the original frame
	...
	/**
	 * initializes the action with an Animation and indicate whether restore the
	 * original frame when the animation is over
	 */
	...
	/**
	 * initializes an action with a duration, animation and depending of the
	 * restoreOriginalFrame, it will restore the original frame or not. The
	 * 'delay' parameter of the animation will be overrided by the duration
	 * parameter.
	 */

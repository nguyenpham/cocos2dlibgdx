 ...
 * 
 * @warning Use this action carefully. This action is not sequenceable. Use it
 *          as the default "reversed" method of your own actions, but using it
 *          outside the "reversed" scope is not recommended.
 */

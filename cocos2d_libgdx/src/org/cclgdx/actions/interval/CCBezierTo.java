...
import org.cclgdx.config.CCBezierConfig;
...
public class CCBezierTo extends CCBezierBy {
	/**
	 * We need to record the original config. Repeating a bezier movement is
	 * continually more and more distorted if we continue to subtract the start
	 * position.
	 */

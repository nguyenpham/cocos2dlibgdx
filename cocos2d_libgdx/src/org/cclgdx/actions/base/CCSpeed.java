...
import org.cclgdx.actions.interval.CCIntervalAction;
import org.cclgdx.nodes.CCNode;

/**
 * Changes the speed of an action, making it take longer (speed>1) or less
 * (speed<1) time. Useful to simulate 'slow motion' or 'fast forward' effect.
 * 
 * @warning This action can't be Sequenceable because it is not an
 *          IntervalAction
 */
